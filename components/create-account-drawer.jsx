...
import { Drawer, DrawerClose,DrawerFooter,DrawerContent,DrawerDescription,DrawerHeader,DrawerTitle,DrawerTrigger } from "./ui/drawer";
    ...
    <div className="px-4 pb-4">
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
                ...
                <Select onValue={(value) => setValue("type",value)} defaultValue={watch("type")}>
